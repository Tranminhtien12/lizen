...
<html lang="vi">
	...
	<title>Đăng nhập &lsaquo; tranminhtien123 &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=6.0" media="all">
	...
	<script type="text/javascript">
		...
		<form name="loginform" id="loginform" action="httplocalhost:7000/maskcodex/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Đăng nhập">
									<input type="hidden" name="redirect_to" value="httplocalhost:7000/maskcodex/wp-admin/">
									<input type="hidden" name="testcookie" value="1">
			</p>
		</form>

					<p id="nav">
								<a href="/wp-login.php?action=lostpassword">Bạn quên mật khẩu?</a>
			</p>
					<script type="text/javascript">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="/">&larr; Quay lại tranminhtien123</a>		</p>
			</div>
...
var _zxcvbnSettings = {"src":"httplocalhost:7000\/maskcodex\/wp-includes\/js\/zxcvbn.min.js"};
</script>
...
var _wpUtilSettings = {"ajax":{"url":"\/maskcodex\/wp-admin\/admin-ajax.php"}};
</script>
<script src="/wp-includes/js/wp-util.min.js?ver=6.0" id="wp-util-js"></script>
<script id="user-profile-js-extra">
var userProfileL10n = {"user_id":"0","nonce":"480977367e"};
</script>
